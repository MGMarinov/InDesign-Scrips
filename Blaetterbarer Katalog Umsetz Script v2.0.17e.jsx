...
function DataProcessors(dependencies) {
    ...
    this.ermittleZielseite = function(sourceItem, inddDoc) {
        try {
            ...
            var linkParent = sourceItem.link.parent;
            ...
            if (linkParent && linkParent.hasOwnProperty("appliedSection")) {
                var section = linkParent.appliedSection;
                if (section && section.pageRange && section.pageRange.length > 0) {
                    return 1;
                }
            }
        } catch (e) {
    ...
    this._bestimmeLinksInDokument = function(doc, layerName) {
        ...
        for (var p = 0; p < doc.pages.length; p++) {
            ...
            for (var k = 0; k < currentPage.allPageItems.length; k++) {
                ...
                // exakte Reihenfolge und Filter wie im Ursprungsskript:
