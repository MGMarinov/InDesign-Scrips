...
var main = function() {
    ...
    // Filter für File-Dialog (z.B. "*.csv")
    var filterPreset = "*" + dateiEndung;

    filePath = File.saveDialog("Speichern unter", filterPreset);

    // Wenn Datei ausgewählt wurde, standardisierten Namen verwenden falls nötig
    if (filePath && filePath.name === "") {
        filePath = new File(filePath.fullName + "/" + standardDateiName);
    }
