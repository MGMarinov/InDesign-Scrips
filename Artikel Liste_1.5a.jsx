...
var main = function() {
    ...
    // Default-Pfad: Verzeichnis des aktuellen Dokuments
    var defaultPath = doc.filePath + "/" + standardDateiName;
    var defaultFile = new File(defaultPath);

    filePath = File.saveDialog("Speichern unter", defaultFile);
